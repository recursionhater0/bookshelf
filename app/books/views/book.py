...
from books.functions import add_to_bookmark, remove_bookmark
    ...
    def get_queryset(self):
        ...
        if self.action in ("list", "retrieve"):
            ...
            bookmark_subquery = Bookmark.objects.filter(
                created_by=user, book_copy=models.OuterRef("pk")
            )
            return (
                ...
                .annotate(is_bookmarked=models.Exists(bookmark_subquery))
            )
        return queryset
...
class BookmarkViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": "Book is successfully added to bookmark"},
    ...
    def remove_bookmark(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": "Book is successfully removed from bookmark"},
            status=status.HTTP_200_OK,
        )
